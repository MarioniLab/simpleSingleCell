---
title: "Analyzing single-cell RNA-seq data with read counts"
author: 
- name: Aaron T. L. Lun
...
date: 1 April 2018
vignette: >
  %\VignetteIndexEntry{Analyzing scRNA-seq data with read counts}
...
```{r qcplot416b, fig.wide=TRUE, fig.cap="Histograms of various QC metrics for all cells in the 416B dataset. This includes the library sizes, number of expressed genes, and proportion of reads mapped to spike-in transcripts or mitochondrial genes."}
...
(We do not use the mitochondrial proportions as we already have the spike-in proportions for this dataset.
...
```{r qcplotbatch416b, fig.wide=TRUE, fig.cap="Distribution of each QC metric for control and oncogene-induced cells in the 416B dataset."}
multiplot(
