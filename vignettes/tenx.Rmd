...
We recommend performing the analysis first with a stringent QC filter, and then relaxing it based on further diagnostics (see `r simpleSingleCell:::.link("qc", "Checking for discarded cell types", "here")` for an example).
