...
See the [_simpleSingleCell_ landing page](https://master.bioconductor.org/packages/devel/workflows/html/simpleSingleCell.html) for links to individual workflows and for instructions on how to install the required packages.
Each workflow starts from a publicly available count matrix and finishes at the characterisation of cell clusters.
