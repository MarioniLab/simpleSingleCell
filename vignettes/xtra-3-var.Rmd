...
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Specials 3: variance modelling in scRNA-seq data}
...
We apply the deconvolution method [@lun206pooling] to compute size factors for the endogenous genes [@lun2016pooling].
