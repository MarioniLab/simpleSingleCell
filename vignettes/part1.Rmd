...
Thus, we typically use Ward's criterion for hierarchical clustering, at least in the first pass.
Of course, it is simple (and recommended) to apply other approaches, provided that some assessment is performed, e.g., using the silhouette width.
