...
We demonstrate this approach with a larger data set in the next `r Biocpkg("simpleSingleCell", vignette="work-2-umis.html#6_normalization_of_cell-specific_biases", label="workflow")`.
