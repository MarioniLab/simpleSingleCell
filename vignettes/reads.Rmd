...
- In the absence of spike-ins, users can set `use.spikes=FALSE` to fit a trend to the variances of the endogenous genes (see `r simpleSingleCell:::.link("var", "When spike-ins are unavailable", "here")`).
...
We will discuss this in more detail `r simpleSingleCell:::.link("var", NULL, "later")`, as formal detection of HVGs is not necessary for feature selection during data exploration.
