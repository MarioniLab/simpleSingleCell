...
- If too few HVGs are selected, we may fail to resolve factors of variation that are not the most dominant in the data,
as discussed above.
In such cases, repeating the entire analysis on each cluster of cells can characterize further heterogeneity within each cluster that was masked in the overall analysis.
...
Of course, this strategy is more labour intensive - in addition to the obvious additional work, more care is required to prevent or reconcile redundant definitions of the same cell type or state in repeated analyses of overclustered data.
