...
We can see the effects of doing so in Figure \@(fig:densclust), where more cells in the suspect cluster have higher doublet scores.

```{r densclust, fig.cap="Distribution of force-matched doublet scores for each cluster in the mammary gland data set. Each point is a cell."}
set.seed(100)
