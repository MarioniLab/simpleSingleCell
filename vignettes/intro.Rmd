...
For data from most plate-based protocols, quantification procedures developed for bulk RNA-seq experiments are generally satisfactory [@love2015rnaseq;@chen2016from].
...
For droplet-based experiments and some very high-throughput plate-based protocols (e.g., MARS-seq), we suggest using the `r Biocpkg("scPipe")` package [@lian2018scpipe].

Some further considerations specific to single-cell data may also be relevant, depending on the experimental protocol used to generate the data:
