...
The `findMarkers()` function recommended in previous workflows uses Welch t-tests

# Using the Wilcoxon rank sum test

The `overlapExprs()` uses the Wilcoxon rank sum test to detect uneven mixing of the distributions of expression values between clusters.
