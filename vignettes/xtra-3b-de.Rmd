...
```{r violde, fig.height=10, fig.asp=1.5, fig.cap="Distribution of log-normalized expression values for the top 10 DE genes between clusters 1 and 2, stratified by cluster assignment and coloured by the plate of origin for each cell."}
