...
```{r, echo=FALSE, results="hide"}
# Checking the cluster is what we wanted, along with cluster 11 (=10 in marker.set).
other.inter <- 11 - 1
...
```{r heatmapmarkerbrain, fig.wide=TRUE, fig.cap="Heatmap of mean-centred and normalized log-expression values for the top set of markers for cluster 4 in the brain dataset. Column colours represent the cluster to which each cell is assigned, as indicated by the legend."}
