---
title: "Analyzing single-cell RNA-seq data with UMI counts"
author: 
- name: Aaron T. L. Lun
...
vignette: >
  %\VignetteIndexEntry{Analyzing single-cell RNA-seq data with UMI counts}
...
```{r tsneclusterbrain, message=FALSE, fig.cap="_t_-SNE plot of the denoised PCs of the brain dataset. Each point represents a cell and is coloured according to the cluster identity to which it was assigned."}
...
plotHeatmap(sce, features=top.markers, columns=order(my.clusters),
    colour_columns_by="cluster", cluster_cols=FALSE, zlim=c(-5, 5))
```
