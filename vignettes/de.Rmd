...
simpleSingleCell:::.compiler("reads") # 416B
simpleSingleCell:::.compiler("batch") # pancreas
```
...
Previous workflows (`r Biocpkg("simpleSingleCell", "work-1-reads.html#detecting-marker-genes-between-clusters", label="here")` and `r Biocpkg("simpleSingleCell", "work-5-mnn.html#using-the-corrected-values-in-downstream-analyses", "here")`) used the `block=` argument in `findMarkers()` to account for uninteresting factors of variation.
...
We demonstrate the use of `overlapExprs()` on the 416B data set from the `r Biocpkg("simpleSingleCell", vignette="work-1-reads.html", label="previous workflow")`,
...
This yields an ordering of genes that can be interpreted in the same manner as discussed `r Biocpkg("simpleSingleCell", "work-1-reads.html#detecting-marker-genes-between-clusters", label="previously")` for `findMarkers()` output.
...
We demonstrate this procedure on the `r Biocpkg("simpleSingleCell", vignette="work-1-reads.html", label="416B data set")` again.
