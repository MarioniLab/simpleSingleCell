...
Higher weights reflect the greater stability of an average count obtained from many cells.
...
We test for DE between the first two clusters using the rest of the QL pipeline.
