...
This is motivated by the fact that low-quality cells can often yield misleading results, clustering separately from other cells; 
containing genes that appear to be strongly "upregulated" due to the presence of very small size factors; 
containing genes that are strongly downregulated due to the loss of RNA upon cell damage; 
