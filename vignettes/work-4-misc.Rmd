...
vignette: >
  %\VignetteIndexEntry{Further strategies for analyzing single-cell RNA-seq data}
...
Paralel analysis also relies on random permutations, so setting the random seed is necessary for reproducible results.
